...
export const mockReservations: Reservation[] = [
  // Available reservations (shared by others, ready to claim)
  {
    id: 'res-1',
    restaurantId: '1',
    restaurant: mockRestaurants[0], // Huda New Levantine Bistro
  ...
  },
  {
    id: 'res-2',
    restaurantId: '2',
    restaurant: mockRestaurants[1], // Rule of Thirds
  ...
  },
  {
    id: 'res-3',
    restaurantId: '3',
    restaurant: mockRestaurants[2], // Din Tai Fung
  ...
  },
  {
    id: 'res-4',
    restaurantId: '4',
    restaurant: mockRestaurants[3], // Jeju Noodle Bar
  ...
  },
  {
    id: 'res-5',
    restaurantId: '5',
    restaurant: mockRestaurants[4], // La Tête d'Or by Daniel
    userId: mockUsers[1].id,
    user: mockUsers[1],
  ...
  },
  {
    id: 'res-6',
    restaurantId: '6',
    restaurant: mockRestaurants[5], // Carbone
  ...
  },
  {
    id: 'res-7',
    restaurantId: '7',
    restaurant: mockRestaurants[6], // Atomix
    userId: mockUsers[2].id,
    user: mockUsers[2],
  ...
  },
  {
    id: 'res-8',
    restaurantId: '8',
    restaurant: mockRestaurants[7], // Superiority Burger
  ...
  },
  {
    id: 'res-9',
    restaurantId: '9',
    restaurant: mockRestaurants[8], // Kochi
    userId: mockUsers[3].id,
    user: mockUsers[3],
  ...
  },
  {
    id: 'res-10',
    restaurantId: '10',
    restaurant: mockRestaurants[9], // Contra
    userId: mockUsers[4].id,
    user: mockUsers[4],
