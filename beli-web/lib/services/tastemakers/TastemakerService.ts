 ...
 * TastemakerService
 *
 * Manages tastemaker (food expert) profiles and content including:
 * - Fetching tastemaker profiles
 * - Tastemaker discovery and search
 * - Tastemaker posts and articles
 * - Post interactions (likes, bookmarks, views)
 *
 * NOTE: Post functionality (articles, interactions) was merged from TastemakerPostService.
 */
...
export class TastemakerService {
  ...
  // ============================================
  // Post Methods (merged from TastemakerPostService)
  // ============================================
