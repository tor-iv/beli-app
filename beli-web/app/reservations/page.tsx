    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16">
        <div className="rounded-xl border border-gray-100 bg-white p-12 text-center shadow-sm">
          ...
          <h2 className="mb-3 text-2xl font-bold text-foreground">No Reservations Yet</h2>

          <p className="mx-auto mb-6 max-w-md text-base text-secondary">
            This feature is coming soon! You&apos;ll be able to view and manage your restaurant
            reservations, claim shared reservations from the community, and share your own
            reservations here.
          </p>

          <div className="mx-auto inline-flex max-w-sm flex-col items-start rounded-lg bg-gray-50 p-4 text-left">
            <p className="mb-2 text-sm font-semibold text-foreground">Coming Soon:</p>
