...
export function RankingResultModal({
  open,
  onOpenChange,
  restaurant,
  user,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-none h-full w-full p-0 gap-0 bg-primary border-0 [&>button]:hidden"
      >
        ...
        <div className="flex flex-col h-full bg-primary overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-4 lg:px-8 pb-12">
            <div className="max-w-[500px] mx-auto space-y-8 pt-8">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-[26px] font-bold italic text-primary">
                    beli
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-2xl font-bold text-foreground flex-1 mr-3">
                    {restaurant.name}
                  </h2>
                ...
                {/* Location metadata */}
                <div className="flex items-center gap-1.5 mb-1.5 text-secondary text-[11px]">
                ...
                {/* Visit count */}
                <div className="flex items-center gap-1.5 mb-3 text-secondary text-[11px]">
                  <svg className="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {photos && photos.length > 0 && (
                  <div className="relative w-full h-[180px] mb-3 rounded-lg overflow-hidden bg-gray-100">
                    <Image
                      src={photos[0]}
              ...
              <div className="bg-white rounded-2xl p-5 shadow-lg">
                ...
                <div className="flex items-center justify-between px-1">
                  ...
                  >
                    <div className="w-[60px] h-[60px] rounded-full bg-gray-500 flex items-center justify-center">
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-1.5 max-w-[80px]"
                  >
                    <div className="w-[60px] h-[60px] rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center">
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-1.5 max-w-[80px]"
                  >
                    <div className="w-[60px] h-[60px] rounded-full bg-green-500 flex items-center justify-center">
