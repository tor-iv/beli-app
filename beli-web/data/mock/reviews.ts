...
export const mockReviews: Review[] = [
  ...
  },
  {
    ...
    content:
      "As a vegetarian, I'm often disappointed by restaurants that treat vegetables as an afterthought. Blue Hill is the complete opposite - vegetables are the star here, and they deserve the spotlight. Every dish was a revelation. The carrot course was so complex and flavorful I couldn't believe it was just carrots. The farm-to-table concept is executed flawlessly. This is the future of fine dining.",
  ...
  },
  {
    ...
    content:
      "This is how steak should be done. The porterhouse for two was cooked to absolute perfection - charred outside, perfectly pink inside. The bacon appetizer is a must-order (trust me on this). Yes, it's cash only and the service can be brusque, but that's part of the charm. This place has been doing steak right for over 130 years and it shows.",
  ...
  },
  {
    ...
    content:
      "Having lived in Tokyo for two years, I'm pretty picky about ramen. Ivan Ramen gets it right. The triple pork ramen has that deep, rich tonkotsu flavor I've been craving. The noodles have the perfect chew and the chashu melts in your mouth. This is what ramen should taste like. Skip the touristy places and come here.",
    photos: ['https://images.unsplash.com/photo-1617093727343-374698b1b08d?w=400'],
  ...
  },
  {
    ...
    content:
      "Yes, it's touristy. Yes, you'll wait. But the pastrami sandwich is legitimately incredible. The meat is piled high, perfectly seasoned, and melts in your mouth. The pickles are the perfect acidic counterpoint. Sure, you can get a good pastrami sandwich elsewhere for less money, but this is the original and it still delivers. Go at least once.",
  ...
  // User 1 (Tor Cox) - 2025 Challenge Reviews
  {
    id: 'tc-1',
    userId: '1',
    restaurantId: '11', // Café Habana
    rating: 6.1,
    content: "Needs salt 🧂 I'm salty.",
    photos: [],
    tags: ['Cuban', 'Casual'],
    ...
    helpfulCount: 3,
    isVerifiedVisit: true,
    orderItems: ['Cuban Sandwich', 'Corn'],
  },
  {
    id: 'tc-2',
    userId: '1',
    restaurantId: '22', // Tacos 1986
    rating: 6.5,
    content: 'Fine tacos',
    photos: [],
    tags: ['Tacos', 'Mexican'],
    ...
    helpfulCount: 2,
    isVerifiedVisit: true,
    orderItems: ['Chicken Tacos', 'Salsa Verde'],
  },
  {
    id: 'tc-3',
    userId: '1',
    restaurantId: '8', // Olle
    rating: 9.1,
    content: 'Absolutely fantastic Korean BBQ. The pork belly was perfectly marbled 🥓',
    photos: [],
    tags: ['Korean', 'BBQ', 'Excellent'],
    visitDate: new Date('2025-10-20'),
    createdAt: new Date('2025-10-20'),
    helpfulCount: 8,
    isVerifiedVisit: true,
    orderItems: ['Pork Belly', 'Short Ribs', 'Kimchi'],
  },
  {
    id: 'tc-4',
    userId: '1',
    restaurantId: '14', // Gramercy Tavern
    rating: 8.7,
    content: 'Seasonal menu was incredible. The duck was cooked perfectly 🦆',
    photos: [],
    tags: ['American', 'Fine Dining'],
    visitDate: new Date('2025-10-18'),
    createdAt: new Date('2025-10-18'),
    helpfulCount: 12,
    isVerifiedVisit: true,
    orderItems: ['Duck Breast', 'Seasonal Vegetables'],
  },
  {
    id: 'tc-5',
    userId: '1',
    restaurantId: '2', // Prince Street Pizza
    rating: 8.9,
    content: 'Best pepperoni slice in the city. Worth the wait 🍕',
    photos: [],
  ...
  },
  {
    ...
    restaurantId: '6', // Momofuku Noodle Bar
    rating: 8.4,
    content: 'Ramen was solid. Pork buns are still the star of the show.',
    photos: [],
    tags: ['Ramen', 'Asian'],
  ...
  },
  {
    ...
    rating: 7.9,
    content: 'Classic French bistro. The onion soup is a must-try 🧅',
    photos: [],
    tags: ['French', 'Bistro'],
    ...
    helpfulCount: 15,
    isVerifiedVisit: true,
    orderItems: ['Onion Soup', 'Steak Frites'],
  },
  {
    id: 'tc-8',
    userId: '1',
    ...
    rating: 7.2,
    content: 'Good late night slice. Nothing fancy but hits the spot.',
    photos: [],
    tags: ['Pizza', 'Late Night'],
    visitDate: new Date('2025-10-08'),
    createdAt: new Date('2025-10-08'),
    helpfulCount: 6,
    isVerifiedVisit: true,
    orderItems: ['Cheese Slice'],
  },
  {
    id: 'tc-9',
    userId: '1',
    restaurantId: '4', // Carbone
    rating: 9.3,
    content: 'Spicy rigatoni is worth the hype. Old school Italian done right 🍝',
    photos: [],
    tags: ['Italian', 'Pasta', 'Premium'],
    visitDate: new Date('2025-10-06'),
    createdAt: new Date('2025-10-06'),
    helpfulCount: 24,
    isVerifiedVisit: true,
    orderItems: ['Spicy Rigatoni', 'Meatballs'],
  },
  {
    id: 'tc-10',
    userId: '1',
    restaurantId: '7', // Shake Shack
    rating: 7.5,
    content: 'Reliable burger. Cheese fries are addictive 🍔',
    photos: [],
    tags: ['Burgers', 'Casual'],
    ...
    helpfulCount: 11,
    isVerifiedVisit: true,
    orderItems: ['ShackBurger', 'Cheese Fries', 'Shake'],
  },
  {
    id: 'tc-11',
    userId: '1',
    restaurantId: 'moody-tongue',
    rating: 8.6,
    content: 'Creative Japanese-Italian fusion. The shiso pepperoni is wild 🌿',
    photos: [],
    tags: ['Fusion', 'Pizza', 'Creative'],
    visitDate: new Date('2025-10-02'),
    createdAt: new Date('2025-10-02'),
    helpfulCount: 14,
    isVerifiedVisit: true,
    orderItems: ['Shiso Pepperoni', 'Miso Burrata Slice'],
  },
  {
    id: 'tc-12',
    userId: '1',
    restaurantId: '20', // Eleven Madison Park
    rating: 9.4,
    content: 'Plant-based tasting menu was extraordinary. Every course was art 🎨',
    photos: [],
    tags: ['Fine Dining', 'Tasting Menu', 'Vegetarian'],
    visitDate: new Date('2025-09-28'),
    createdAt: new Date('2025-09-28'),
    helpfulCount: 31,
    isVerifiedVisit: true,
    orderItems: ['Tasting Menu'],
  },
  {
    id: 'tc-13',
    userId: '1',
    restaurantId: '13', // The Halal Guys
    rating: 7.8,
    content: 'Late night classic. White sauce makes everything better 🥙',
    photos: [],
    tags: ['Halal', 'Street Food', 'Late Night'],
    visitDate: new Date('2025-09-25'),
    createdAt: new Date('2025-09-25'),
    helpfulCount: 7,
    isVerifiedVisit: true,
    orderItems: ['Chicken & Rice', 'White Sauce'],
  },
  {
    id: 'tc-14',
    userId: '1',
    restaurantId: '12', // Ivan Ramen
    rating: 8.2,
    content: 'Broth is incredible. Noodles have perfect chew.',
    photos: [],
    tags: ['Ramen', 'Japanese'],
    ...
    helpfulCount: 10,
    isVerifiedVisit: true,
    orderItems: ['Tonkotsu Ramen', 'Gyoza'],
  },
  {
    id: 'tc-15',
    userId: '1',
    restaurantId: '19', // Peter Luger
    rating: 8.8,
    content: 'Porterhouse is legendary. Bring cash and an appetite 🥩',
    photos: [],
    tags: ['Steakhouse', 'Brooklyn', 'Classic'],
    visitDate: new Date('2025-09-18'),
    createdAt: new Date('2025-09-18'),
    helpfulCount: 22,
    isVerifiedVisit: true,
    orderItems: ['Porterhouse for Two', 'Bacon'],
  },
  {
    id: 'tc-16',
    userId: '1',
    ...
    rating: 9.0,
    content: 'French fine dining at its finest. Soufflé was perfect ✨',
    photos: [],
    tags: ['French', 'Fine Dining', 'Dessert'],
    visitDate: new Date('2025-09-15'),
    createdAt: new Date('2025-09-15'),
    helpfulCount: 19,
    isVerifiedVisit: true,
    orderItems: ['Tasting Menu', 'Chocolate Soufflé'],
  },
  {
    id: 'tc-17',
    userId: '1',
    restaurantId: '10', // Le Bernardin
    rating: 9.5,
    content: 'Best seafood in NYC. Every dish is perfection 🐟',
    photos: [],
    tags: ['Seafood', 'Michelin Star', 'Fine Dining'],
    visitDate: new Date('2025-09-12'),
    createdAt: new Date('2025-09-12'),
    helpfulCount: 28,
    isVerifiedVisit: true,
    orderItems: ['Tuna Tartare', 'Black Bass'],
  },
  {
    id: 'tc-18',
    userId: '1',
    restaurantId: '27', // Blue Hill
    rating: 8.9,
    content: 'Farm to table perfection. Vegetables never tasted so good 🌽',
    photos: [],
    tags: ['Farm-to-Table', 'American', 'Seasonal'],
    visitDate: new Date('2025-09-08'),
    createdAt: new Date('2025-09-08'),
    helpfulCount: 16,
    isVerifiedVisit: true,
    orderItems: ['Seasonal Tasting Menu'],
  },
  {
    id: '10',
  ...
  },
  {
    ...
    content:
      "The sommelier at Le Bernardin is world-class. Each wine pairing elevated the already exceptional seafood to new heights. The Sancerre with the tuna tartare was inspired, and the Burgundy with the lobster was perfection. The service team's knowledge of both wine and food is encyclopedic. This is what fine dining should be - flawless execution at every level.",
    photos: ['https://images.unsplash.com/photo-1544148103-0773bf10d330?w=400'],
  ...
  },
  {
    ...
    content:
      "I've had a lot of burgers in this city, but nothing compares to the Black Label Burger at Minetta Tavern. The dry-aged beef blend creates this incredible depth of flavor that you just can't get anywhere else. It's expensive for a burger, but it's not really a burger - it's an experience. The bone marrow appetizer is also incredible.",
    photos: ['https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400'],
  ...
  },
  {
    ...
    content:
      "When you need food at 2 AM and want something that won't break the bank, Halal Guys delivers every time. The chicken and rice combo with white sauce and hot sauce is the perfect drunk food. It's not gourmet, but it doesn't pretend to be. It's honest, filling, and always hits the spot.",
  ...
  },
  {
    ...
    content:
      'The chocolate soufflé at Daniel is worth the 20-minute wait. Light as air but intensely chocolatey, with a molten center that flows like lava. The pastry team here is world-class. Every dessert is a work of art, but they never sacrifice flavor for presentation. This is what fine dining desserts should be.',
    photos: ['https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400'],
